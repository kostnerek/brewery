...
<body>
    <div class="center">
        <form action="action/importAction.php" method="POST" id="main-form" enctype="multipart/form-data">
            ...
            ?>
                ...
                <input
                    style='color: black; border: 2px black solid; background-color: #861821; margin-top:1%; margin-bottom:1%; border-radius:4px'
                    type="file" name="file">
                <input
                    style="border: 2px black solid; background-color: #861821; margin-top:1%; margin-bottom:1%; border-radius:4px"
